                ...
                <div class="col-lg-8">
                    ...
                    <div class="standard__blog__post">
                        ...
                        <div class="standard__blog__content">
                            ...
                            <h2 class="title"><a href="blog-details.html">{{ $blog->title }}</a></h2>
                            <p>{!! $blog->description !!}</p>
                            <ul class="blog__post__meta">
                                <li><i class="fal fa-calendar-alt"></i> {{ Carbon\Carbon::parse($blog->created_at)->format('d-m-Y ') }} </li>
                    ...
                    <aside class="blog__sidebar">
                            ...
                            <ul class="rc__post">
                                ...
                                <li class="rc__post__item">
                                    ...
                                    <div class="rc__post__content">
                                        ...
                                        <span class="post-date"><i class="fal fa-calendar-alt"></i>{{ Carbon\Carbon::parse($item->created_at) }}</span>
                                    </div>
                                </li>
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__cat">
                                @forelse ($bolgCat as $cat)

                                <li class="sidebar__cat__item"><a href="blog.html">{{ $cat->blog_cate }}</a></li>
                                @empty
                                <p>NO Record Found</p>
