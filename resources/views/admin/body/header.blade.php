    ...
    <div class="navbar-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div>
                                        <img src="assets/images/megamenu-img.png" alt="megamenu-img" class="mx-auto img-fluid d-block">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('adminProfile') }}"><i class="align-middle ri-user-line me-1"></i> Profile</a>
                    <a class="dropdown-item" href="{{ route('update') }}"><i class="align-middle ri-wallet-2-line me-1"></i> Change Password</a>
                    ...
                    <a class="dropdown-item text-danger" href="{{ route('admin.destroy') }}"><i class="align-middle ri-shut-down-line me-1 text-danger"></i> Logout</a>
                </div>
            </div>
